 ...
 */
@Entity
@Table(name = "PROJECT_TASK_ATTRIBUTE_TEXT_VALUE_DB_TABLE")
public record ProjectTaskAttributeTextValueTableSchema(
        @Id
        ...
        @Column(name = "TASK_ATTRIBUTE_VALUE", columnDefinition = "text", nullable = false)
