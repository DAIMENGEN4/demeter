 ...
 */
@Entity
@Table(name = "PROJECT_TASK_ATTRIBUTE_MEDIUMTEXT_VALUE_DB_TABLE")
public record ProjectTaskAttributeMediumtextValueTableSchema(
        @Id
        ...
        @Column(name = "TASK_ATTRIBUTE_VALUE", columnDefinition = "mediumtext", nullable = false)
