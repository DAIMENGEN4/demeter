 ...
 */
@Entity
@Table(name = "PROJECT_TASK_ATTRIBUTE_LONGTEXT_VALUE_DB_TABLE")
public record ProjectTaskAttributeLongtextValueTableSchema(
        @Id
        ...
        @Column(name = "TASK_ATTRIBUTE_VALUE", columnDefinition = "longtext", nullable = false)
